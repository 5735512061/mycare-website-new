            ...
            <div class="col-md-2"></div>
                <div class="col-md-4 margin-design" style="margin-top:5rem; background-color:#fff;">
                    <form method="POST" action="{{ route('login') }}" autocomplete="off">@csrf
                        ...
                        <h1 style="text-align:center;">เข้าสู่ระบบแอดมิน</h1><hr style="border: 1px solid blue;">
                        <div class="row">
                            <div class="mt-10 col-md-12">
                                <input type="text" class="single-input" style="font-family:Prompt;" placeholder="ชื่อเข้าใช้งาน" onfocus="this.placeholder = 'ชื่อเข้าใช้งาน'" name="admin_name" value="{{ old('admin_name') }}" required>
                            </div>
                            <div class="mt-10 col-md-12">
