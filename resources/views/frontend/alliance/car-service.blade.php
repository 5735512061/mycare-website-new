	...
	<div class="container">
		<div class="row d-flex align-items-center justify-content-between" style="height: 300px !important;">
			<div class="home-banner-content col-lg-12 col-md-12">
				<center><h2 class="" style="font-size:2rem; color:#000085 !important; font-weight: normal !important;"><img src="{{ asset('/img/mycare/symbol/arrow.png')}}" width="4%"> เพื่อนแท้ ดูแลรถยนต์</h2></center>
...
<div class="container">
	...
	<div class="row">
	  @foreach($carservices as $carservice => $value)
		<div class="col-md-4">
			<a href="{{url('alliance/detail/')}}/{{$value->id}}">
				...
				<div class="card-caption">
					...
					{{-- <p style="color:#092895;">รับคะแนนสะสม {{$value->point}} คะแนน</p> --}}
          			<h4>โปรโมฃั่น {{$value->date}} - {{$value->expire}}</h4>
