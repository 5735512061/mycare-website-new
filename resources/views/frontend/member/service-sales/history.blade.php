	...
	<div class="container">
		<div class="row d-flex align-items-center justify-content-between" style="height: 300px !important;">
			<div class="home-banner-content col-lg-12 col-md-12">
				<center><h2 style="font-size:2rem; color:#000085 !important; font-weight: normal !important;">ประวัติการใช้บริการ</h2></center>
                                        ...
                                        <h4 class="panel-title">
                                            <?php 
                                                $list = DB::table('sales_services')->where('date',$value->date)
                                                                                   ...
                                                                                   ->count();
                                            ?>
                                            <a href="{{url('/member/sales/service-information/')}}/{{$value->id}}">
                                                วันที่ใช้บริการ {{$value->date}} เข้าใช้บริการ {{$value->branch}} {{$list}} รายการ
                                            </a>
                                        </h4>
                                    </div>
                                </div>
