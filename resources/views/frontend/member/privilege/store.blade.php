      ...
      <div class="right" style="margin-top: -580px !important; height:520px !important;">
        <form class="sendurl">
            ...
            <div class="form-group">
                <input style="background-color: #0517c4 !important;" class="genric-btn info radius btn_sub" type="submit" value="กดปุ่มเพื่อรับสิทธิ์" data-toggle="modal" data-target="#myModal"><br>
            </div>
        </form>  
            ...
            <a href="#">
				...
				<div class="card-caption">
                    <form class="sendurl">
                        ...
                        <div class="form-group">
                            <center><input style="background-color: #0517c4 !important;" class="genric-btn info radius btn_sub" type="submit" value="กดปุ่มเพื่อรับสิทธิ์" data-toggle="modal" data-target="#myModal"></center>
                        </div>
                    </form>
                </div>
        ...
        data: {
            ...
            success: function(response) {
                ...
                if(response.status === "FULL") {
                    $('#tag-id').html('<p style="text-align: center; color:red;">ไม่สามารถรับสิทธิ์ได้<br> เนื่องจากวันนี้ท่านได้ใช้สิทธิ์ไปแล้ว</p><p style="margin-top:5px;font-size:15px; text-align: center; color:red;">คุณสามารถใช้สิทธิ์ครั้งต่อไปได้ในวันถัดไป</p>')
                }
                    ...
                    $('#tag-id').html('<p style="text-align: center; font-weight: bold; color:#0517c4;">สิทธิพิเศษสำหรับ คุณ'+response.member.name+'</p><p style="text-align: center; color:#0517c4;">คุณได้'+response.store.promotion+'</p><p style="text-align: center; background-color:#0517c4; color:#ffffff; margin:0px 80px 0px 80px;">'+response.statistic.code+'</p><p style="margin-top:5px;font-size:15px; text-align: center; color:red;">คุณสามารถใช้สิทธิ์ครั้งต่อไปได้ในวันถัดไป</p><p style="margin-top:5px;font-size:15px; text-align: center; color:#979797;">* กรุณาแสดงรหัส คู่บัตร MY CARE ต่อพนักงาน เพื่อยืนยันการสิทธิ์</p>')
                }
                // else if(response.status === "PassSecond") {
                //     $('#tag-id').html('<p style="text-align: center; font-weight: bold; color:#0517c4;">สิทธิพิเศษสำหรับ คุณ'+response.member.name+'</p><p style="text-align: center; color:#0517c4;">คุณได้'+response.store.promotion+'</p><p style="text-align: center; background-color:#0517c4; color:#ffffff; margin:0px 80px 0px 80px;">'+response.statistic.code+'</p><p style="margin-top:5px;font-size:15px; text-align: center; color:red;">คุณสามารถใช้สิทธิ์ครั้งต่อไปได้ในเดือนถัดไป</p><p style="margin-top:5px;font-size:15px; text-align: center; color:#979797;">* กรุณาแสดงรหัส คู่บัตร MY CARE ต่อพนักงาน เพื่อยืนยันการสิทธิ์</p>')
                // }
