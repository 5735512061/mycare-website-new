...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8">
            <form action="{{url('/staff/member/create-member')}}" enctype="multipart/form-data" method="post">@csrf
                <h2>ข้อมูลผู้สมัครสมาชิก <i class="fa fa-caret-down" style="color:#777777;"></i></h2><br>
                <div class="row">
                    <div class="mt-12 col-md-12">
                        <input type="text" id="ssn" maxlength="19" minlength="19" name="serialnumber" placeholder="กรอกหมายเลขบัตรสมาชิก 16 หลัก" onfocus="this.placeholder = 'กรอกหมายเลขบัตรสมาชิก 16 หลัก'" class="single-input" value="{{$member->serialnumber}}" readonly>
                    </div>
                </div><br>
                <div class="row">
                    <div class="mt-10 col-md-6">
                        <input type="text" name="name" placeholder="ชื่อ" onfocus="this.placeholder = 'ชื่อ'" class="single-input" value="{{$member->name}}" readonly>
                    </div>
                    <div class="mt-10 col-md-6">
                        <input type="text" name="surname" placeholder="นามสกุล" onfocus="this.placeholder = 'นามสกุล'" class="single-input" value="{{$member->surname}}" readonly>
                    </div>
                </div>
                <div class="row">
                    <div class="mt-10 col-md-6">
                        <input type="text" name="bday" placeholder="วัน/เดือน/ปี ค.ศ เกิด" onfocus="this.placeholder = 'วัน/เดือน/ปี ค.ศ เกิด'" class="single-input" value="{{$member->bday}}" readonly>
                    </div>
                    <div class="mt-10 col-md-6">
                        <input type="text" name="tel" placeholder="เบอร์โทรติดต่อ" onfocus="this.placeholder = 'เบอร์โทรติดต่อ'" class="phone_format single-input" value="{{$member->tel}}" readonly>
                    </div>
                    <div class="row">
                        <div class="large-7 small-12 column">
                            <input data-date-format="dd/mm/yyyy" id="datepicker" name="date" type="hidden" value="{{$member->date}}" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="large-7 small-12 column">
                            <input data-date-format="dd/mm/yyyy" id="expirepicker" name="expire" type="hidden" value="{{$member->expire}}" readonly>
                        </div>
                    </div>
                </div><br>
