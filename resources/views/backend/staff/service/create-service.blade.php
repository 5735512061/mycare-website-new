...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-10 col-md-10">
            <form action="{{url('/staff/create-service')}}" enctype="multipart/form-data" method="post">@csrf
                ...
                <div class="row">
                    <div class="mt-10 col-md-6">
                        @if(auth('staff')->user()->branch == 'สาขาบายพาส')
                        <input name="branch" class="single-input" type="text" value="สาขาบายพาส">
                        @elseif(auth('staff')->user()->branch == 'สาขาถลาง')
                        <input name="branch" class="single-input" type="text" value="สาขาถลาง">
                        @elseif(auth('staff')->user()->branch == 'สาขาเจ้าฟ้า')
                        <input name="branch" class="single-input" type="text" value="สาขาเจ้าฟ้า">
                        @elseif(auth('staff')->user()->branch == 'สาขาไทวัสดุ')
                        <input name="branch" class="single-input" type="text" value="สาขาไทวัสดุ">
                        @elseif(auth('staff')->user()->branch == 'สาขาโคกกลอย')
                        <input name="branch" class="single-input" type="text" value="สาขาโคกกลอย">
                        @elseif(auth('staff')->user()->branch == 'สาขาเมืองพังงา')
                        <input name="branch" class="single-input" type="text" value="สาขาเมืองพังงา">
                        @endif
                    </div>
                    <div class="mt-10 col-md-6">
                ...
                <div class="row">
                    <div class="mt-10 col-md-6">
                        <input type="text" name="miles" placeholder="เลขไมล์ล่าสุด (กรอกเป็นตัวเลข)" onfocus="this.placeholder = 'เลขไมล์ล่าสุด (กรอกเป็นตัวเลข)'" class="single-input">
                    </div>
                </div> <br>
                ...
                <div class="row">
                    <div class="mt-10 col-md-6">
                        <input type="text" name="discount" placeholder="ส่วนลด (กรอกเป็นตัวเลข)" onfocus="this.placeholder = 'ส่วนลด (กรอกเป็นตัวเลข)'" class="single-input" value="0">
                    </div>
                    <div class="mt-10 col-md-6">
                        <input type="text" name="discountturn" placeholder="หักเทริน (กรอกเป็นตัวเลข)" onfocus="this.placeholder = 'หักเทริน (กรอกเป็นตัวเลข)'" class="single-input" value="0">
                    </div>
                </div>
                <div class="row">
                    <div class="mt-10 col-md-6">
