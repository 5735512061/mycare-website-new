	...
	<div class="container">
		<div class="row d-flex align-items-center justify-content-between" style="height: 250px !important;">
			<div class="home-banner-content col-lg-12 col-md-12">
				<center><h2 class="" style="font-size:2rem; color:#000085 !important; font-weight: normal !important;"><img src="{{ asset('/img/mycare/symbol/arrow.png')}}" width="4%"> สมัครสมาชิกเซลล์</h2></center>
...
<div class="container" style="background-color: #fff;">
    <div class="row" style="margin-top:-90px !important;">
        ...
        <div class="col-lg-8 col-md-8">
            <form action="{{url('/staff/sales-register')}}" enctype="multipart/form-data" method="post">@csrf
                ...
                <div class="row">
                    <div class="mt-10 col-md-6">
                        ...
                        <input id="file-upload" name="file" type="file" class="form-control" value="{{old('file')}}"/>
                    </div>
                </div>
                <br>
                @foreach (['danger', 'warning', 'success', 'info'] as $msg)
                    ...
                    @endif
                @endforeach
                <p><input type="checkbox" id="checkme"> ยอมรับเงื่อนไขในการสมัครเป็นสมาชิก MY CARE</p>
                <button class="genric-btn info radius btn_sub" disabled="disabled" id="sendNewSms">สมัครสมาชิกเซลล์</button>
                <br><br>
            </form>
        </div>
    </div>
...
<script>
    ...
    $('#expirepicker').datepicker("setDate", '+365d');
