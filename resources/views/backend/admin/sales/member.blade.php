...
<div class="container">
    <div class="row">
        <div class="panel-heading">
            <P><a class="genric-btn info radius" href="{{url('/admin/sales-register/')}}">สมัครสมาชิกเซลล์</a>
            <a class="genric-btn info radius" href="{{url('/admin/sales-registerWarning/')}}">เปิดบัตรสมาชิกเซลล์</a></P>
        </div>
        <div class="receipt-main col-xs-12 col-sm-12 col-md-12">
            <div class="row">
                <div class="col-md-12">
                    <br>
                    <form action="{{url('/admin/sales/search-member')}}" enctype="multipart/form-data" method="post">@csrf
                        <input class="form-control ssn" maxlength="19" minlength="19" type="text" placeholder="ค้นหาหมายเลขบัตรสมาชิก" name="serialnumber">
                    </form>
                    <form action="{{url('/admin/sales/search-member')}}" enctype="multipart/form-data" method="post">@csrf
                        <input class="phone_format form-control" type="text" placeholder="ค้นหาเบอร์โทรศัพท์" name="tel">
                    </form>
                    @if($members == '0') 
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="color: #000; text-align:center;">ชื่อเซลล์</th>
                        ...
                        <tbody id="myTable" class="table">
                            <tr>
                                ...
                                <td><a style="color: #000;" href="{{url('/admin/information-sales/')}}/{{$memberId}}">{{$value->serialnumber}}</a></td>
                            ...
                            ?>
                                ...
                                <td>
                                    <center>
                                        <a href="{{url('/admin/information-sales/')}}/{{$memberId}}">
                                ...
                                <td>
                                    <center>
                                        <a href="{{url('/admin/sales-edit/')}}/{{$memberId}}">
                                            <i class="fa fa-pencil-square" style="color:blue;"></i>
                                        </a>                                    
                                        <a href="{{url('/admin/sales-delete/')}}/{{$memberId}}" onclick="return confirm('Are you sure to delete ?')">
