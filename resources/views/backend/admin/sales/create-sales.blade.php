...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8">
            <form action="{{url('/admin/create-sales')}}" enctype="multipart/form-data" method="post">@csrf
                <h2>หมายเลขสมาชิก <i class="fa fa-caret-down" style="color:#777777;"></i></h2><br>
                <div class="row">
                ...
                <div class="row">
                    <div class="mt-12 col-md-3">
                      <input type="text" name="carnumber" class="single-input" value="ปด{{$date}}">
                    </div>
                    <div class="mt-12 col-md-3">
                ...
                <div class="row">
                  <div class="mt-12 col-md-3">
                    <input type="checkbox" name="typeCar" value="รถส่วนบุคคล">
                    <label style="font-family: 'Prompt' !important;">รถส่วนบุคคล</label>
                  </div>
                  <div class="mt-12 col-md-3">
                    <input type="checkbox" name="typeCar" value="รถลูกค้า">
                    <label style="font-family: 'Prompt' !important;">รถลูกค้า</label>
                  </div>
                </div><br>
