...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-12"> 
                    <br><a href="{{url('/admin/sales/sales-edit/')}}/{{$member->id}}" class="btn btn-warning"><i class="fa fa-exclamation-triangle"></i> เปิดบัตรสมาชิก</a>
                </div>
            </div><br>
            <div class="row">
                <div class="col-md-12">
...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            ...
            <img src="{{url('/images/file/sales')}}/{{$member->file}}" width="50%";>
        </div>
    </div>
</div><br>
@endsection