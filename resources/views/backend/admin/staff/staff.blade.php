                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="color: #000; text-align:center;">ชื่อเข้าใช้งาน</th>
                                <th style="color: #000; text-align:center;">สาขา</th>
                                <th style="color: #000; text-align:center;">รหัสผ่าน</th>
                                <th></th>
                            </tr>   
                        </thead>
                        ...
                        <tbody class="table">
                            <tr>
                                <td style="color: #000;">{{$NUM_PAGE*($page-1) + $staff+1}}</td>
                                <td style="color: #000;">{{$value->staff_name}}</td>
                                <td style="color: #000;">{{$value->branch}}</td>
                                <td style="color: #000;">{{$value->pw}}</td>
                                <td style="text-align:center;">
                                    <a href="{{url('/admin/staff-delete/')}}/{{$value->id}}" onclick="return confirm('Are you sure to delete ?')">
