    ...
    <div class="row">
        <div class="receipt-main col-xs-12 col-sm-12 col-md-12">
            <div class="row">
                <div class="col-md-12">
                    <br>
                    <a href="{{url('admin/member-registerWarning')}}" class="genric-btn info radius btn_sub">! สมัครผ่านเว็บไซต์</a>
                    <br><br>
                    {{-- <input class="form-control ssn" maxlength="19" minlength="19" id="myInput" type="text" placeholder="ค้นหาหมายเลขบัตรสมาชิก"> --}}
                    {{-- <input class="form-control" id="myInput2" type="text" placeholder="ค้นหาอื่นๆ"> --}}
                    <form action="{{url('/admin/member/search-member')}}" enctype="multipart/form-data" method="post">@csrf
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="myTable" class="table">
                            <tr>
                                ...
                                <td><a style="color: #000;" href="{{url('/admin/information-member/')}}/{{$memberId}}">{{$value->serialnumber}}</a></td>
                                ...
                                <td>
                                    <center>
                                        <a href="{{url('/admin/information-member/')}}/{{$memberId}}">
                                ...
                                <td>
                                    <center>
                                        <a href="{{url('/admin/member-edit/')}}/{{$memberId}}">
                                            <i class="fa fa-pencil-square" style="color:blue;"></i>
                                        </a>                                    
                                        <a href="{{url('/admin/member-delete/')}}/{{$memberId}}" onclick="return confirm('Are you sure to delete ?')">
