	...
	<div class="container">
		<div class="row d-flex align-items-center justify-content-between" style="height:250px !important;">
			<div class="home-banner-content col-lg-12 col-md-12">
				<h2 style="text-align:center; color:#092895;">แก้ไขข้อมูลสมาชิก</h2><hr style="border: 1px solid blue;">
			</div>
		</div>
	</div>
</section>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8">
            <form action="{{url('/admin/member-update')}}" enctype="multipart/form-data" method="post">@csrf
                ...
                <div class="row">
                    <div class="mt-10 col-md-6">
                        <input type="text" name="date" class="single-input" value="{{$member->date}}">
                    </div>
                    <div class="mt-10 col-md-6">
                        <input type="text" name="expire" class="single-input" value="{{$member->expire}}">
                    </div>
                </div><br>
                ...
                <button class="genric-btn info radius">อัพเดตข้อมูลสมาชิก</button>
                <br><br>
            </form>
        </div>
    </div>
