	...
	<div class="container">
		<div class="row d-flex align-items-center justify-content-between" style="height:250px !important;">
			<div class="home-banner-content col-lg-12 col-md-12">
				<h2 style="text-align:center; color:#092895;">แก้ไขของรางวัล</h2><hr style="border: 1px solid blue;">
			</div>
		</div>
	</div>
</section>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8">
            <form action="{{url('/admin/reward-update')}}" enctype="multipart/form-data" method="post">@csrf
                ...
                <div class="row">
                    <div class="mt-10 col-md-6">
                        <input type="text" name="reward_name" class="single-input" value="{{$reward->reward_name}}">
                    </div>
                    <div class="mt-10 col-md-6">
                        <input type="text" name="point" class="single-input" value="{{$reward->point}}">
                    </div>
                    <div class="mt-10 col-md-6">
                        <input type="text" name="expire" class="single-input" value="{{$reward->expire}}">
                    </div>
                    <div class="mt-10 col-md-6">
                        <input type="text" name="comment" class="single-input" value="{{$reward->comment}}">
                    </div>
                    <div class="mt-10 col-md-6">
                        <label for="file-upload" class="custom-file-upload" style=" padding-right:244px;">
                            <i class="fa fa-cloud-upload"></i> รูปภาพ
                        </label>
                        <input id="file-upload" name="image" type="file" class="form-control" value="{{$reward->image}}"/>
                    </div>
                    <div class="mt-10 col-md-6">
                        <div class="row">
                            <div class="col-md-4">
                ...
                <button class="genric-btn info radius">แก้ไขของรางวัล</button>
                <br><br>
            </form>
        </div>
    </div>
